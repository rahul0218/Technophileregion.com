...
<div class="col-sm-9 col-xs-12 content pt-3 pl-0">
                    ...
                    <div class="col-sm-6">
                        <div class="mt-1 mb-3 p-3 button-container bg-white shadow-sm border">
                            ...
                            <div class="feed-single mb-3">
                                <div class="media">
                                    <img class="mr-3 rounded-circle" height="40px" width="40px" src="<?php echo base_url('assets/admin/img/user.png');?>" alt="Generic placeholder image">
                ...
                <div class="row mt-5 mb-4 footer">
                    <div class="col-sm-8">
                        <span>&copy; All rights reserved 2020 designed by <a class="text-theme" href="#">Technophileregion</a></span>
                    </div>
